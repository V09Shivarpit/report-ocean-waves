...
const citiesData: CityClimateData[] = [
  ...
  // EAST COAST - ODISHA
  {
    ...
    oceanicClimate: {
      seaSurfaceTemp: { current: 28.4, min: 26.7, max: 30.3, unit: '°C' },
      humidity: { current: 85, average: 82, unit: '%' },
      windSpeed: { current: 19.2, direction: 'SE', maxGust: 26.8, unit: 'km/h' },
      waveHeight: { current: 2.3, significant: 2.7, max: 3.9, unit: 'm' },
      salinity: { current: 34.6, average: 34.8, unit: 'PSU' },
      tideLevel: { current: 2.5, nextHigh: '13:30', nextLow: '19:55', unit: 'm' },
    },
    airQuality: { aqi: 94, pm25: 43, pm10: 71, status: 'Good' },
    lastUpdated: new Date(),
  },
  {
    id: 'bhubaneswar',
    ...
    oceanicClimate: {
      seaSurfaceTemp: { current: 28.1, min: 26.4, max: 30.0, unit: '°C' },
      humidity: { current: 82, average: 79, unit: '%' },
      windSpeed: { current: 17.8, direction: 'E', maxGust: 24.5, unit: 'km/h' },
      waveHeight: { current: 2.0, significant: 2.4, max: 3.5, unit: 'm' },
      salinity: { current: 34.7, average: 34.9, unit: 'PSU' },
      tideLevel: { current: 2.3, nextHigh: '13:45', nextLow: '20:10', unit: 'm' },
    },
    airQuality: { aqi: 128, pm25: 64, pm10: 91, status: 'Moderate' },
    lastUpdated: new Date(),
  },
  {
    id: 'paradip',
    name: 'Paradip',
    state: 'Odisha',
    coordinates: { latitude: 20.3050, longitude: 86.6761 },
    oceanicClimate: {
      seaSurfaceTemp: { current: 28.6, min: 26.9, max: 30.5, unit: '°C' },
      humidity: { current: 87, average: 84, unit: '%' },
      windSpeed: { current: 21.4, direction: 'SE', maxGust: 29.1, unit: 'km/h' },
      waveHeight: { current: 2.6, significant: 3.0, max: 4.2, unit: 'm' },
      salinity: { current: 34.8, average: 35.0, unit: 'PSU' },
      tideLevel: { current: 2.8, nextHigh: '13:15', nextLow: '19:40', unit: 'm' },
    },
    airQuality: { aqi: 145, pm25: 75, pm10: 103, status: 'Moderate' },
    lastUpdated: new Date(),
  },
  ...
  // EAST COAST - WEST BENGAL
  {
    ...
    oceanicClimate: {
      seaSurfaceTemp: { current: 27.9, min: 25.8, max: 29.8, unit: '°C' },
      humidity: { current: 89, average: 86, unit: '%' },
      windSpeed: { current: 16.3, direction: 'SE', maxGust: 23.7, unit: 'km/h' },
      waveHeight: { current: 1.8, significant: 2.2, max: 3.3, unit: 'm' },
      salinity: { current: 33.9, average: 34.1, unit: 'PSU' },
      tideLevel: { current: 2.9, nextHigh: '12:50', nextLow: '19:25', unit: 'm' },
    },
    airQuality: { aqi: 167, pm25: 89, pm10: 124, status: 'Moderate' },
    lastUpdated: new Date(),
  },
  {
    id: 'digha',
    name: 'Digha',
    state: 'West Bengal',
    coordinates: { latitude: 21.6667, longitude: 87.5167 },
    oceanicClimate: {
      seaSurfaceTemp: { current: 28.3, min: 26.5, max: 30.1, unit: '°C' },
      humidity: { current: 86, average: 83, unit: '%' },
      windSpeed: { current: 18.9, direction: 'E', maxGust: 25.4, unit: 'km/h' },
      waveHeight: { current: 2.1, significant: 2.5, max: 3.7, unit: 'm' },
      salinity: { current: 34.2, average: 34.4, unit: 'PSU' },
      tideLevel: { current: 2.6, nextHigh: '13:20', nextLow: '19:50', unit: 'm' },
    },
    airQuality: { aqi: 92, pm25: 41, pm10: 66, status: 'Good' },
    lastUpdated: new Date(),
  },
  
  // ADDITIONAL WEST COAST CITIES - GUJARAT
  {
    id: 'jamnagar',
    name: 'Jamnagar',
    state: 'Gujarat',
    ...
    oceanicClimate: {
      seaSurfaceTemp: { current: 26.9, min: 24.2, max: 29.1, unit: '°C' },
      humidity: { current: 66, average: 63, unit: '%' },
      windSpeed: { current: 19.7, direction: 'W', maxGust: 27.8, unit: 'km/h' },
      waveHeight: { current: 2.1, significant: 2.5, max: 3.7, unit: 'm' },
      salinity: { current: 35.9, average: 35.7, unit: 'PSU' },
      tideLevel: { current: 2.9, nextHigh: '13:25', nextLow: '19:50', unit: 'm' },
    },
    airQuality: { aqi: 112, pm25: 56, pm10: 81, status: 'Moderate' },
    lastUpdated: new Date(),
  },
  {
    id: 'bhavnagar',
    ...
    oceanicClimate: {
      seaSurfaceTemp: { current: 27.4, min: 25.3, max: 29.6, unit: '°C' },
      humidity: { current: 69, average: 66, unit: '%' },
      windSpeed: { current: 17.2, direction: 'SW', maxGust: 25.1, unit: 'km/h' },
      waveHeight: { current: 1.8, significant: 2.1, max: 3.2, unit: 'm' },
      salinity: { current: 35.6, average: 35.5, unit: 'PSU' },
      tideLevel: { current: 2.4, nextHigh: '14:15', nextLow: '20:40', unit: 'm' },
    },
    airQuality: { aqi: 98, pm25: 45, pm10: 72, status: 'Good' },
    lastUpdated: new Date(),
  },
  
  // ADDITIONAL WEST COAST CITIES - KARNATAKA
  {
    id: 'karwar',
    name: 'Karwar',
    state: 'Karnataka',
    coordinates: { latitude: 14.8138, longitude: 74.1292 },
    oceanicClimate: {
      seaSurfaceTemp: { current: 28.5, min: 26.8, max: 30.4, unit: '°C' },
      humidity: { current: 84, average: 81, unit: '%' },
      windSpeed: { current: 11.3, direction: 'W', maxGust: 17.1, unit: 'km/h' },
      waveHeight: { current: 1.5, significant: 1.8, max: 2.7, unit: 'm' },
      salinity: { current: 35.2, average: 35.1, unit: 'PSU' },
      tideLevel: { current: 1.7, nextHigh: '16:05', nextLow: '22:15', unit: 'm' },
    },
    airQuality: { aqi: 64, pm25: 27, pm10: 44, status: 'Good' },
    lastUpdated: new Date(),
  },
  {
    id: 'bhatkal',
    name: 'Bhatkal',
    state: 'Karnataka',
    coordinates: { latitude: 13.9865, longitude: 74.5583 },
    oceanicClimate: {
      seaSurfaceTemp: { current: 28.9, min: 27.1, max: 30.9, unit: '°C' },
      humidity: { current: 86, average: 83, unit: '%' },
      windSpeed: { current: 10.1, direction: 'SW', maxGust: 15.8, unit: 'km/h' },
      waveHeight: { current: 1.4, significant: 1.7, max: 2.4, unit: 'm' },
      salinity: { current: 35.3, average: 35.2, unit: 'PSU' },
      tideLevel: { current: 1.6, nextHigh: '16:15', nextLow: '22:00', unit: 'm' },
    },
    airQuality: { aqi: 59, pm25: 25, pm10: 42, status: 'Good' },
    lastUpdated: new Date(),
  },
  ...
  // ISLANDS - ANDAMAN & NICOBAR
  {
    ...
    oceanicClimate: {
      seaSurfaceTemp: { current: 29.7, min: 28.2, max: 31.3, unit: '°C' },
      humidity: { current: 91, average: 89, unit: '%' },
      windSpeed: { current: 6.8, direction: 'SE', maxGust: 12.4, unit: 'km/h' },
      waveHeight: { current: 0.7, significant: 0.9, max: 1.8, unit: 'm' },
      salinity: { current: 35.8, average: 35.6, unit: 'PSU' },
      tideLevel: { current: 0.9, nextHigh: '17:30', nextLow: '23:15', unit: 'm' },
    },
    airQuality: { aqi: 38, pm25: 15, pm10: 28, status: 'Good' },
    lastUpdated: new Date(),
  },
  ...
  // ISLANDS - LAKSHADWEEP
  {
    ...
    oceanicClimate: {
      seaSurfaceTemp: { current: 28.8, min: 27.5, max: 30.2, unit: '°C' },
      humidity: { current: 92, average: 90, unit: '%' },
      windSpeed: { current: 7.2, direction: 'W', maxGust: 13.1, unit: 'km/h' },
      waveHeight: { current: 0.6, significant: 0.8, max: 1.5, unit: 'm' },
      salinity: { current: 36.1, average: 35.9, unit: 'PSU' },
      tideLevel: { current: 0.8, nextHigh: '17:45', nextLow: '23:30', unit: 'm' },
    },
    airQuality: { aqi: 25, pm25: 8, pm10: 18, status: 'Good' },
    lastUpdated: new Date(),
  },
    ...
    hotspots: [
      {
        ...
        riskScore: 78,
        totalReports: 145,
        cities: citiesData.filter(city => ['dwarka', 'porbandar', 'kandla', 'jamnagar', 'bhavnagar'].includes(city.id)),
        averageConditions: {
          temperature: 26.8,
          waveHeight: 2.2,
          windSpeed: 18.5,
      ...
      },
      {
        ...
        riskScore: 65,
        totalReports: 87,
        cities: citiesData.filter(city => ['mangalore', 'udupi', 'karwar', 'bhatkal', 'goa'].includes(city.id)),
        averageConditions: {
          temperature: 28.9,
          waveHeight: 1.4,
          windSpeed: 10.1,
  ...
  },
  {
    ...
    hotspots: [
      ...
      },
      {
        ...
        riskScore: 76,
        totalReports: 156,
        cities: citiesData.filter(city => ['puri', 'bhubaneswar', 'paradip'].includes(city.id)),
        averageConditions: {
          temperature: 27.6,
          waveHeight: 1.7,
          windSpeed: 14.5,
      ...
      },
      {
        ...
        riskScore: 92,
        totalReports: 267,
        cities: citiesData.filter(city => ['kolkata', 'digha'].includes(city.id)),
        averageConditions: {
          temperature: 26.9,
          waveHeight: 1.4,
          windSpeed: 11.6,
